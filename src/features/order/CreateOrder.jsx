  ...
  return (
    <div className="px-4 py-6">
      ...
      <Form method="POST" action="/order/new">
        <div className="mb-5 flex gap-2 felx-col sm:flex-row sm:items-center">
        ...
        <div className="mb-5 flex gap-2 felx-col sm:flex-row sm:items-center relative">
          ...
          {!position.latitute && !position.longitute && (
